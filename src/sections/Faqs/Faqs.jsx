...
const faqCategories = [
  {
    ...
    questions: [
      {
        q: "Can I bring a <b>plus one</b>?",
        a: "Please check with us on WhatsApp before you RSVP to confirm if you can bring a plus one.",
      },
      {
        q: "Will there be <b>transportation</b> available while in Medugorje?",
  ...
  },
  {
    ...
    questions: [
      {
        q: "Do I need a <b>Visa</b> to get to Medugorje?",
      ...
      {
        q: "Which <b>airport</b> do I fly to?",
      ...
      {
        q: "If I fly through <b>Split</b>, how do I get <b>to Medugorje</b>?",
      ...
      {
        q: "What <b>touristic activities</b> can I do while in Croatia and Hercegovina?",
