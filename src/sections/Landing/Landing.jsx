  ...
  return (
    <section id="landing" className="section">
      <div className="landing-content">
        ...
        <p className="font-text landing-text landing-text--faded landing-text--big">Saturday, September 12th</p>
        ...
        />
        <a href="#rsvp" className="font-text landing-rsvp">RSVP by August 29th</a>
      </div>
    </section>
  )
}
